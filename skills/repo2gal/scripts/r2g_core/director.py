...
def build_annotation_prompt(
    ...
    *,
    ...
    template = resources.files("r2g_core").joinpath("prompts/annotations.md").read_text(encoding="utf-8")
    return (
...
def build_director_prompt(
    ...
    *,
    ...
    template = resources.files("r2g_core").joinpath("prompts/director.md").read_text(encoding="utf-8")
    return (
